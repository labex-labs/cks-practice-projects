...
[LabEx でプロジェクトを見る](https://labex.io/ja/learn/cks)

## プロジェクト

初心者向けの 3 個の CKS トレーニング プロジェクトで、言語の重要な概念を小さく完成したプログラムに変えて学べます。各プロジェクトは LabEx のすぐ使える環境で開くため、構築に集中できます。

|   インデックス | プロジェクト                                                          | 難易度   | 練習                                                            |
|----------|-----------------------------------------------------------------|-------|---------------------------------------------------------------|
|        1 | [CKS 試験対策コース](https://labex.io/ja/courses/cks-prep)             | 初級    | [プロジェクトを開始](https://labex.io/ja/courses/cks-prep)             |
|        2 | [CKS 模擬試験 01](https://labex.io/ja/courses/cks-practice-exam-01) | 上級    | [プロジェクトを開始](https://labex.io/ja/courses/cks-practice-exam-01) |
|        3 | [CKS 模擬試験 02](https://labex.io/ja/courses/cks-practice-exam-02) | 上級    | [プロジェクトを開始](https://labex.io/ja/courses/cks-practice-exam-02) |
